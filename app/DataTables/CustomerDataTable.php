...
class CustomerDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('tipe', function ($data) {
                if ($data->tipe == 'ekspor') {
                    return '<span class="badge bg-info text-white">' . $data->tipe . '</span>';
                } else {
                    return '<span class="badge bg-blue text-white">' . $data->tipe . '</span>';
                }
            })
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('customer.create')) {
    ...
    {
        $column = [];
        // $column[] = Column::checkbox('<input type="checkbox"></input>');
        if (PermissionCommon::check('customer.delete') || PermissionCommon::check('customer.update')) {
        ...
        $column[] = Column::make('nama')->title("Nama Customer");
