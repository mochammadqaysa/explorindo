...
class BarangDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('barang_jadi.create')) {
    ...
    {
        $column = [];
        if (PermissionCommon::check('barang_jadi.delete') || PermissionCommon::check('barang_jadi.update')) {
        ...
        $column[] = Column::make('nama')->title("Nama Barang");
        $column[] = Column::make('warna');
        $column[] = Column::make('panjang');
        $column[] = Column::make('lebar');
        $column[] = Column::make('tebal');
