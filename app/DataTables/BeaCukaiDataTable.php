...
class BeaCukaiDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\BeaCukai $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BeaCukai $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('beacukai.create')) {
            $button[] = Button::raw('<i class="fa fa-plus"></i> Create Bea Cukai')->action('function() { create() }');
        }
        return $this->builder()
            ->parameters([
                'language' => [
    ...
    {
        $column = [];
        if (PermissionCommon::check('beacukai.delete') || PermissionCommon::check('beacukai.update')) {
        ...
        $column[] = Column::make('kode')->title("Kode Kantor");
        $column[] = Column::make('nama')->title("Nama Kantor");
