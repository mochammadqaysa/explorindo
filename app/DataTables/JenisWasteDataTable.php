...
class JenisWasteDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        $user = AuthCommon::getUser();
        if (PermissionCommon::check('jenis_waste.create')) {
    ...
    {
        $column = [];
        if (PermissionCommon::check('jenis_waste.delete') || PermissionCommon::check('jenis_waste.update')) {
        ...
        $column[] = Column::make('nama')->title("Nama Jenis Waste");
        return $column;
    }
