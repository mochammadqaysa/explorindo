...
class WasteDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('waste.create')) {
    ...
    {
        $column = [];
        if (PermissionCommon::check('waste.delete') || PermissionCommon::check('waste.update')) {
        ...
        $column[] = Column::make('nama')->title("Nama Waste");
        return $column;
    }
