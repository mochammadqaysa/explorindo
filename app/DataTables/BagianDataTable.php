...
class BagianDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('bagian.create')) {
    ...
    {
        $column = [];
        if (PermissionCommon::check('bagian.delete') || PermissionCommon::check('bagian.update')) {
        ...
        $column[] = Column::make('nama')->title("Nama Bagian");
        return $column;
    }
