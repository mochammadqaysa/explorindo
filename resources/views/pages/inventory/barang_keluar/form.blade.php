    ...
    <div class="step-body" data-tab="1">
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="nomor_bukti" class="form-control" placeholder="Nomor Invoice" style="text-transform:uppercase">
        </div>
        <div class="form-group col-md-6 ">
          <label>Tanggal Invoice <span class="text-danger">*</span></label>
          <div class='date'>
              <input type='text' class="form-control" name="tanggal_bukti" id='tanggal_bukti' style="background-color: white; " placeholder="Pilih Tanggal Invoice" value="" />
          </div>
        </div>
          ...
          <table class="table table-borderless align-items-left table-flush table-header col-md-6">
              <tbody>
                  <tr>
                      <td>Nomor Invoice</td>
                      <td>:</td>
                      <th class="nomor-bukti">Nomor Invoice</th>
                  </tr>
                  <tr>
                      <td>Tanggal Invoice</td>
                      <td>:</td>
                      <th class="tanggal-bukti">Invoice</th>
                  </tr>
                  <tr>
                      <td>Customer</td>
                      <td>:</td>
