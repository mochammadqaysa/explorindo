    ...
    <div class="step-body" data-tab="1">
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="nomor_bukti" class="form-control" placeholder="Nomor Invoice" style="text-transform:uppercase" value="{{ @$data->nomor_bukti }}">
        </div>
        <div class="form-group col-md-6 ">
          <label>Tanggal Invoice <span class="text-danger">*</span></label>
          <div class='date'>
              <input type='text' class="form-control" name="tanggal_bukti" id='tanggal_bukti' style="background-color: white; " placeholder="Pilih Tanggal Invoice" value="{{ @$data->tanggal_bukti }}" />
          </div>
        </div>
