    ...
    <div class="step-body" data-tab="1">
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="nomor_sj" class="form-control" placeholder="Nomor Surat Jalan" style="text-transform:uppercase" value="{{ @$data->nomor_sj }}">
        </div>
        <div class="form-group col-md-6 ">
          <label>Tanggal Surat Jalan <span class="text-danger">*</span></label>
          <div class='date'>
              <input type='text' class="form-control" name="tanggal_sj" id='tanggal_sj' style="background-color: white; " placeholder="Pilih Tanggal Surat Jalan" value="{{ @$data->tanggal_sj }}" />
          </div>
        </div>
          ...
          <table class="table table-borderless align-items-left table-flush table-header col-md-6">
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>:</td>
                      <th class="tanggal-sj">Tanggal Surat Jalan</th>
                  </tr>
                  <tr>
                      <td>Customer</td>
                      <td>:</td>
