...
<script>
  let _url = {
    create: `{{ route('barang-keluar-gudang.create') }}`,
    edit: `{{ route('barang-keluar-gudang.edit', ':id') }}`,
    show: `{{ route('barang-keluar-gudang.show', ':id') }}`,
    destroy: `{{ route('barang-keluar-gudang.destroy', ':id') }}`
  }
