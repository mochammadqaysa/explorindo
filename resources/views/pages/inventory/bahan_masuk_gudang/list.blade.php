...
<script>
  let _url = {
    create: `{{ route('bahan-masuk-gudang.create') }}`,
    edit: `{{ route('bahan-masuk-gudang.edit', ':id') }}`,
    show: `{{ route('bahan-masuk-gudang.show', ':id') }}`,
    destroy: `{{ route('bahan-masuk-gudang.destroy', ':id') }}`
  }
