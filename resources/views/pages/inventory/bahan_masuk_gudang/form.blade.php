...
<script>
  ...
  function collectAndDisplayData() {
      ...
      if (tipe == 'lokal') {
        ...
        $('#table-bahanmasuk-ringkasan th:nth-child(7)').hide();
        $('#table-bahanmasuk-ringkasan td:nth-child(7)').hide();
      } else {
        ...
        $('#table-bahanmasuk-ringkasan th:nth-child(7)').show();
        $('#table-bahanmasuk-ringkasan td:nth-child(7)').show();
      }
  }
  //stepper
  var max_step = 3
