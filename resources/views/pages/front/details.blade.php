		...
		<div class="row mt-md-5">
			<div class="col-12">
				...
				<div class="splide splide-main mb-3" data-splide='{"type" : "fade","autoplay": true,"heightRatio":0.5,"pagination":false,"arrows":false,"cover":true,"lazyLoad":"sequential"}'>
					<div class="splide__track">
						<ul class="splide__list">
							<li class="splide__slide rounded"><img src="{{asset('front/images/04.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/04.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/05.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/05.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/03.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/03.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/09.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/09.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/10.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/10.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/06.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/06.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/07.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/07.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
							<li class="splide__slide rounded"><img src="{{asset('front/images/08.jpg')}}" alt="">
								<!-- Glightbox image -->
								<a href="{{asset('front/images/08.jpg')}}" class="stretched-link" data-glightbox="" data-gallery="banner"></a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="splide splide-thumb" data-splide='{"rewind":true,"fixedWidth":200,"fixedHeight":120,"isNavigation":true,"gap":20,"focus":"center","pagination":false,"cover":true,"lazyLoad":"sequential","breakpoints":{"600":{"fixedWidth":150,"fixedHeight":80}}}'>
					<div class="splide__track">
						<ul class="splide__list">
							<li class="splide__slide"><img src="{{asset('front/images/04.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/05.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/03.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/09.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/10.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/06.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/07.jpg')}}" alt=""></li>
							<li class="splide__slide"><img src="{{asset('front/images/08.jpg')}}" alt=""></li>
						</ul>
					</div>
					<!-- Arrows -->
								...
								<div class="accordion accordion-icon accordion-bg-light" id="accordionExample2">
									...
									<div class="accordion-item mb-3">
										<h6 class="accordion-header font-base" id="heading-1">
											<button class="accordion-button rounded d-inline-block collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
												<span class="lead me-1 fw-normal">Day 1:</span>Arrival in Kuta | Get ready for an ideal escape on this tropical island
											</button>
										</h6>
										<!-- Body -->
												...
												<div class="vstack gap-4">
													...
													<div class="card bg-transparent p-0">
														...
														<div class="card-header bg-transparent p-0">
															<span class="text-body"><i class="fa-solid fa-check-circle me-2"></i>Flight details</span>
															<div class="p-3 bg-light rounded-2 d-sm-flex justify-content-sm-between align-items-center mb-4 mt-2">
																...
																<h6 class="fw-normal mb-0"><span class="text-body">Date:</span> 4 July 2022</h6>
															</div>
														</div>
														...
														<div class="card-body p-0">
															<div class="row g-4">
																...
																<div class="col-md-3">
																	<!-- Image -->
																	<img src="{{asset('front/images/09.svg')}}" class="w-80px mb-3" alt="">
																	<!-- Title -->
													...
													<div class="card bg-transparent p-0">
														<!-- Card header -->
														<div class="card-header bg-transparent p-0">
															<span class="text-body"><i class="fa-solid fa-check-circle me-2"></i>Transfer from Airport to hotel</span>
														</div>
															...
															<div class="row g-2 g-sm-4 align-items-center">
																...
																<div class="col-sm-4 col-xl-3">
																	<div class="bg-light rounded-3 px-4 py-5">
																		<img src="{{asset('front/images/seadan.svg')}}" alt="">
																	</div>
																</div>
								
																<!-- Card title and rating -->
																<div class="col-sm-8 col-xl-9">
																	<h5 class="card-title mb-2">Private Transfers</h5>
																	...
																	<a href="#" class="btn btn-sm btn-danger-soft mb-0">Remove</a>
																</div>
															</div> <!-- Row END -->
														</div>	
													</div>
													...
													<div class="card bg-transparent p-0">
														<!-- Card header -->
														<div class="card-header bg-transparent p-0">
															<span class="text-body"><i class="fa-solid fa-check-circle me-2"></i>Check-In to hotel</span>
														</div>
														...
														<div class="card-body p-0 mt-2">
															<div class="row g-2 g-sm-4">
																<!-- Card image -->
																<div class="col-sm-4">
																	<img src="{{asset('front/images/04_2.jpg')}}" class="card-img" alt="Card image">
																</div>
																...
																<div class="col-sm-8">
																	...
																	<div class="d-flex justify-content-between mb-2">
																		...
																		<a href="hotel-list.html" class="btn btn-sm btn-link p-0 mb-0 text-decoration-underline">Change</a>
																	</div>
																	...
																	<ul class="list-group list-group-borderless mb-0 mt-2 small">
																		<li class="list-group-item d-flex p-0">
																			<i class="far fa-calendar-alt me-2"></i>Tue, 5 Jul 2022 - Sat 9 Jul 2022
																		</li>
																	...
																	<h6 class="mb-0 fw-light small mt-2">
																		...
																		<a href="hotel-detail.html" class="btn btn-sm btn-link p-0 mb-0 text-decoration-underline ms-2">Change room</a>
																	</h6>
													...
													<div class="card bg-transparent p-0">
														...
														<div class="card-body p-0 mt-2">
															<div class="row g-2 g-sm-4 align-items-center">
																<!-- Card image -->
																<div class="col-sm-4">
																	<img src="{{asset('front/images/04_1.jpg')}}" class="card-img" alt="">
																</div>
								
																<!-- Card title and rating -->
																<div class="col-sm-8">
																	<h5 class="card-title mb-0">Sightseeing in Bali</h5>
																	<small class="mb-2"><i class="bi bi-geo-alt me-2"></i>Bali, Malaysia</small>

																	<!-- List -->
																	<ul class="list-group list-group-borderless mb-0 mt-2">
																		<li class="list-group-item d-flex p-0">
																			<i class="bi bi-arrow-right text-primary me-2"></i>Tanah Lot Tour
																		</li>
																		<li class="list-group-item d-flex p-0">
																			<i class="bi bi-arrow-right text-primary me-2"></i>White water rafting
																		</li>
																	</ul>

																	<div class="hstack gap-3 flex-wrap mt-2">
																		<p class="mb-0">Duration:<span class="h6 fw-light mb-0 ms-1">5 hrs</span></p>
																		<p class="mb-0">Place Covered:<span class="h6 fw-light mb-0 ms-1">2</span></p>
																	</div>
													...
													<!-- Button -->
													<a href="#" class="btn btn-primary mb-0"><i class="fa-solid fa-person-skating me-2"></i>Add Activity</a>
									...
									<div class="accordion-item mb-3">
										<h6 class="accordion-header font-base" id="heading-2">
											<button class="accordion-button rounded d-inline-block collapsed d-block pe-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
												<span class="lead me-1 fw-normal">Day 2:</span>A day filled with adventure | Indulge in Water sports at Tanjung Benoa Nusa Dua
											</button>
										</h6>
										<!-- Body -->
										<div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionExample2">
											<div class="accordion-body mt-3">
												...
												<ul>
													...
													<li class="mb-2">Son agreed to others Exeter period myself few yet nature. Mention Mr manners opinion if garrets enabled. To occasional dissimilar impossible sentiments.</li>
													<li class="mb-2">Insipidity the sufficient discretion imprudence resolution sir him decisively. Proceed how any engaged visitor. Explained propriety off out perpetual his you. Feel sold off felt nay rose met you.</li>
													...
													<li class="mb-2">Offered chiefly farther of my no colonel shyness. Such on help ye some door if in. Laughter proposal laughing any son law consider. </li>
													<li class="mb-2">Applauded no discovery in newspaper allowance am northward. September how men saw tolerably two behavior arranging. </li>
												</ul>
		
												<div class="row g-4">
													<div class="col-md-4">
														<img src="{{asset('front/images/03_1.jpg')}}" class="rounded-3" alt="">
													</div>
													<div class="col-md-4">
														<img src="{{asset('front/images/02.jpg')}}" class="rounded-3" alt="">
													</div>
													<div class="col-md-4">
														<img src="{{asset('front/images/01_1.jpg')}}" class="rounded-3" alt="">
													</div>
												</div>
									...
									<div class="accordion-item mb-3">
										<h6 class="accordion-header font-base" id="heading-3">
											<button class="accordion-button collapsed rounded d-block pe-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
												<span class="lead me-1 fw-normal">Day 3:</span>Indulge in Water sports at Tanjung Benoa Nusa Dua
											</button>
										</h6>
										<!-- Body -->
									...
									<div class="accordion-item mb-3">
										<h6 class="accordion-header font-base" id="heading-4">
											<button class="accordion-button collapsed rounded d-block pe-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
												<span class="lead me-1 fw-normal">Day 4:</span>Departure, Its Time to say Goodbye
											</button>
										</h6>
										<!-- Body -->
					...
					<div class="col-md-6 col-xl-12">
						<div class="card card-body border bg-transparent">
							...
							<div class="d-grid gap-2">
								<a href="tour-booking.html" class="btn btn-primary">Book Now</a>
