									...
									<div class="card shadow rounded-2 overflow-hidden">
										<div class="row g-0">
											...
											<div class="col-sm-6 col-md-4">
												<img src="images/03.jpg" class="" alt="">
											</div>
									...
									<div class="card border">
										...
										<div class="card-body">
											...
											<div class="row g-4">
												...
												<div class="col-md-3">
													<!-- Image -->
													<img src="images/09.svg" class="w-80px mb-3" alt="">
													<!-- Title -->
								...
								<div class="vstack gap-4">
									...
									<div class="card border">
										...
										<div class="card-header border-bottom d-sm-flex justify-content-between align-items-center">
											...
											<ul class="list-inline my-0">
												<li class="list-inline-item"> <a href="#"><img src="images/visa.svg" class="h-30px" alt=""></a></li>
												<li class="list-inline-item"> <a href="#"><img src="images/mastercard.svg" class="h-30px" alt=""></a></li>
												<li class="list-inline-item"> <a href="#"><img src="images/expresscard.svg" class="h-30px" alt=""></a></li>
											</ul>
										</div>
											...
											<div class="row g-4">
												...
												<div class="col-12">
													...
													<div class="position-relative form-control-bg-light">
														...
														<img src="images/visa.svg" class="w-30px position-absolute top-50 end-0 translate-middle-y me-2 d-none d-sm-block" alt="">
													</div>	
												</div>
									...
									<div class="card border">
										...
										<div class="card-body text-center">
											<!-- Image -->
											<img src="images/paypal.svg" class="h-70px mb-3" alt="">
