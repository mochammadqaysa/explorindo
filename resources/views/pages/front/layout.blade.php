<html lang="en" data-bs-theme="light"><head>
	...
	<!-- Plugins CSS -->
	<link rel="stylesheet" type="text/css" href="{{asset('assets/vendor/@fortawesome/fontawesome-pro/css/all.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front/assets/vendor/bootstrap_icons/bootstrap_icons.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front/assets/vendor/tiny_slider/tiny_slider.css')}}">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="{{asset('front/assets/images/logo.svg')}}" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="{{asset('front/assets/images/logo_light.svg')}}" alt="logo">
			</a>
			<!-- Logo END -->
...
<section class="pt-0">
	<div class="container position-relative">
		<!-- Bg image -->
		<div class="rounded-3 p-4 p-sm-5" style="background-image: url('{{asset('front/assets/images/bg/02.jpg')}}'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			<!-- Banner title -->
				...
				<div class="col-md-5 col-lg-4 col-xl-3 mb-3 mb-sm-0">
					<div class="card shadow p-2 pb-0">
						...
						<div class="position-absolute top-0 start-0 mt-n3 ms-n3 z-index-9">
							<img src="{{asset('front/assets/images/element/05.svg')}}" class="position-relative h-70px" alt="">
						...
						<div class="rounded-3 overflow-hidden position-relative">
							<!-- Image -->
							<img src="{{asset('front/assets/images/category/tour/05.jpg')}}" class="card-img" alt="">
							<!-- Overlay -->
							...
							<div class="row g-4">
								...
								<div class="col-md-6 col-lg-4">
									...
									<div class="form-border-bottom form-control-transparent form-fs-lg mt-2">
										<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"><div class="choices__inner"><select class="form-select js-choice choices__input" data-search-enabled="true" hidden="" tabindex="-1" data-choice="active"><option value="" data-custom-properties="[object Object]">Select location</option></select><div class="choices__list choices__list--single"><div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" data-custom-properties="[object Object]" aria-selected="true">Select location</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="search" name="search_terms" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="Select location" placeholder=""><div class="choices__list" role="listbox"><div id="choices--u8bw-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Select location</div><div id="choices--u8bw-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="San Jacinto, USA" data-select-text="Press to select" data-choice-selectable="">San Jacinto, USA</div><div id="choices--u8bw-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="North Dakota, Canada" data-select-text="Press to select" data-choice-selectable="">North Dakota, Canada</div><div id="choices--u8bw-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="West Virginia, Paris" data-select-text="Press to select" data-choice-selectable="">West Virginia, Paris</div></div></div></div>
									</div>
								</div>
								...
								<div class="col-md-6 col-lg-4">
									...
									<!-- Input field -->
									<div class="form-border-bottom form-control-transparent form-fs-lg mt-2">
										<input type="text" class="form-control flatpickr py-2 flatpickr-input" data-date-format="d M Y" placeholder="Choose a date" readonly="readonly">
									</div>
								</div>
								...
								<div class="col-md-6 col-lg-4">
									...
									<!-- Input field -->
									<div class="form-border-bottom form-control-transparent form-fs-lg mt-2">
										<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"><div class="choices__inner"><select class="form-select js-choice choices__input" data-search-enabled="true" hidden="" tabindex="-1" data-choice="active"><option value="" data-custom-properties="[object Object]">Select type</option></select><div class="choices__list choices__list--single"><div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" data-custom-properties="[object Object]" aria-selected="true">Select type</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="search" name="search_terms" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="Select type" placeholder=""><div class="choices__list" role="listbox"><div id="choices--avoj-item-choice-1" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Select type</div><div id="choices--avoj-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Adventure" data-select-text="Press to select" data-choice-selectable="">Adventure</div><div id="choices--avoj-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="Beach" data-select-text="Press to select" data-choice-selectable="">Beach</div><div id="choices--avoj-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="Desert" data-select-text="Press to select" data-choice-selectable="">Desert</div><div id="choices--avoj-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="History" data-select-text="Press to select" data-choice-selectable="">History</div></div></div></div>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->
						<img src="{{asset('front/assets/images/category/tour/04.jpg')}}" class="card-img" alt="">
						<!-- Overlay -->
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->
						<img src="{{asset('front/assets/images/category/tour/02.jpg')}}" class="card-img" alt="">
						<!-- Overlay -->
						<div class="card-img-overlay d-flex flex-column z-index-1 p-4">
							<!-- Card overlay top -->
							<div class="d-flex justify-content-between">
			...
			<div class="col-sm-6 col-xl-3">
				<div class="card card-img-scale overflow-hidden bg-transparent">
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->
						<img src="{{asset('front/assets/images/category/tour/03.jpg')}}" class="card-img" alt="">
						<!-- Overlay -->
						<div class="card-img-overlay d-flex flex-column z-index-1 p-4">
							<!-- Card overlay top -->
							<div class="d-flex justify-content-between">
			...
			<div class="col-sm-6 col-xl-3">
				<div class="card card-img-scale overflow-hidden bg-transparent">
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->
						<img src="{{asset('front/assets/images/category/tour/01.jpg')}}" class="card-img" alt="">
						<!-- Overlay -->
						<div class="card-img-overlay d-flex flex-column z-index-1 p-4">
							<!-- Card overlay top -->
							<div class="d-flex justify-content-between">
		...
		<div class="row g-4 g-xl-5">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/20.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/19.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/18.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/17.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/16.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/15.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="row g-2 g-md-3 align-items-center position-relative">
						<!-- Image -->
						<div class="col-md-6">
							<img src="{{asset('front/assets/images/category/hotel/nearby/14.jpg')}}" class="rounded-3" alt="">
						</div>
						<!-- Content -->
						<div class="col-md-6">
							<div class="p-2 p-md-0">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="row g-2 g-md-3 align-items-center position-relative">
					<!-- Image -->
					<div class="col-md-6">
						<img src="{{asset('front/assets/images/category/hotel/nearby/13.jpg')}}" class="rounded-3" alt="">
					</div>
					<!-- Content -->
					<div class="col-md-6">
						<div class="p-2 p-md-0">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="{{asset('front/assets/images/category/tour/06.jpg')}}" class="rounded-3" alt="">
							<!-- Full screen button -->
						...
						<div class="tiny-slider arrow-round arrow-blur arrow-hover arrow-xs my-4 mb-md-0">
							<div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">4</span>  of 2</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div class="tiny-slider-inner pb-1  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-dots="false" data-items="1" id="tns1" style="transform: translate3d(-50%, 0px, 0px);"><div class="card bg-transparent tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
								...
								</div><div class="card bg-transparent tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
									<div class="row align-items-center">
										<!-- Image -->
										<div class="col-4">
											<img src="{{asset('front/assets/images/team/02.jpg')}}" class="card-img" alt="">
										</div>
										<!-- Card body -->
										<div class="col-8">
											<div class="card-body p-0">
								...
								<!-- Testimonial item -->
								<div class="card bg-transparent tns-item" id="tns1-item0" aria-hidden="true" tabindex="-1">
									<div class="row align-items-center">
										<!-- Image -->
										<div class="col-4">
											<img src="{{asset('front/assets/images/team/01.jpg')}}" class="card-img" alt="">
								...
								<!-- Testimonial item -->
								<div class="card bg-transparent tns-item tns-slide-active" id="tns1-item1">
									<div class="row align-items-center">
										<!-- Image -->
										<div class="col-4">
											<img src="{{asset('front/assets/images/team/02.jpg')}}" class="card-img" alt="">
					...
					<div class="col-md-6">
						...
						<div class="card card-element-hover card-overlay-hover overflow-hidden mb-4">
							<!-- Image -->
							<img src="{{asset('front/assets/images/gallery/02.jpg')}}" class="rounded-3" alt="">
							<!-- Full screen button -->
						...
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="{{asset('front/assets/images/gallery/03.jpg')}}" class="rounded-3" alt="">
							<!-- Full screen button -->
			...
			<div class="row g-4 justify-content-between">
				...
				<div class="col-md-5 col-lg-4">
					...
					<a class="me-0" href="index.html">
						<img class="light-mode-item h-40px" src="{{asset('front/assets/images/logo.svg')}}" alt="logo">
            <img class="dark-mode-item h-40px" src="{{asset('front/assets/images/logo_light.svg')}}" alt="logo">
					</a>
...
<!-- Vendors -->
<script src="{{asset('front/assets/vendor/tiny_slider/tiny_slider.js')}}"></script>
...
<!-- ThemeFunctions -->
<script src="assets/js/functions.js"></script><div class="flatpickr-calendar" tabindex="-1"><div class="flatpickr-months"><span class="flatpickr-prev-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M5.207 8.471l7.146 7.147-0.707 0.707-7.853-7.854 7.854-7.853 0.707 0.707-7.147 7.146z"></path></svg></span><div class="flatpickr-month"><div class="flatpickr-current-month"><select class="flatpickr-monthDropdown-months" aria-label="Month" tabindex="-1"><option class="flatpickr-monthDropdown-month" value="0" tabindex="-1">January</option><option class="flatpickr-monthDropdown-month" value="1" tabindex="-1">February</option><option class="flatpickr-monthDropdown-month" value="2" tabindex="-1">March</option><option class="flatpickr-monthDropdown-month" value="3" tabindex="-1">April</option><option class="flatpickr-monthDropdown-month" value="4" tabindex="-1">May</option><option class="flatpickr-monthDropdown-month" value="5" tabindex="-1">June</option><option class="flatpickr-monthDropdown-month" value="6" tabindex="-1">July</option><option class="flatpickr-monthDropdown-month" value="7" tabindex="-1">August</option><option class="flatpickr-monthDropdown-month" value="8" tabindex="-1">September</option><option class="flatpickr-monthDropdown-month" value="9" tabindex="-1">October</option><option class="flatpickr-monthDropdown-month" value="10" tabindex="-1">November</option><option class="flatpickr-monthDropdown-month" value="11" tabindex="-1">December</option></select><div class="numInputWrapper"><input class="numInput cur-year" type="number" tabindex="-1" aria-label="Year"><span class="arrowUp"></span><span class="arrowDown"></span></div></div></div><span class="flatpickr-next-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M13.207 8.472l-7.854 7.854-0.707-0.707 7.146-7.146-7.146-7.148 0.707-0.707 7.854 7.854z"></path></svg></span></div><div class="flatpickr-innerContainer"><div class="flatpickr-rContainer"><div class="flatpickr-weekdays"><div class="flatpickr-weekdaycontainer">
      <span class="flatpickr-weekday">
        Sun</span><span class="flatpickr-weekday">Mon</span><span class="flatpickr-weekday">Tue</span><span class="flatpickr-weekday">Wed</span><span class="flatpickr-weekday">Thu</span><span class="flatpickr-weekday">Fri</span><span class="flatpickr-weekday">Sat
      </span>
      </div></div><div class="flatpickr-days" tabindex="-1"><div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="December 29, 2024" tabindex="-1">29</span><span class="flatpickr-day prevMonthDay" aria-label="December 30, 2024" tabindex="-1">30</span><span class="flatpickr-day prevMonthDay" aria-label="December 31, 2024" tabindex="-1">31</span><span class="flatpickr-day" aria-label="January 1, 2025" tabindex="-1">1</span><span class="flatpickr-day" aria-label="January 2, 2025" tabindex="-1">2</span><span class="flatpickr-day" aria-label="January 3, 2025" tabindex="-1">3</span><span class="flatpickr-day" aria-label="January 4, 2025" tabindex="-1">4</span><span class="flatpickr-day" aria-label="January 5, 2025" tabindex="-1">5</span><span class="flatpickr-day" aria-label="January 6, 2025" tabindex="-1">6</span><span class="flatpickr-day" aria-label="January 7, 2025" tabindex="-1">7</span><span class="flatpickr-day" aria-label="January 8, 2025" tabindex="-1">8</span><span class="flatpickr-day" aria-label="January 9, 2025" tabindex="-1">9</span><span class="flatpickr-day" aria-label="January 10, 2025" tabindex="-1">10</span><span class="flatpickr-day" aria-label="January 11, 2025" tabindex="-1">11</span><span class="flatpickr-day" aria-label="January 12, 2025" tabindex="-1">12</span><span class="flatpickr-day today" aria-label="January 13, 2025" aria-current="date" tabindex="-1">13</span><span class="flatpickr-day" aria-label="January 14, 2025" tabindex="-1">14</span><span class="flatpickr-day" aria-label="January 15, 2025" tabindex="-1">15</span><span class="flatpickr-day" aria-label="January 16, 2025" tabindex="-1">16</span><span class="flatpickr-day" aria-label="January 17, 2025" tabindex="-1">17</span><span class="flatpickr-day" aria-label="January 18, 2025" tabindex="-1">18</span><span class="flatpickr-day" aria-label="January 19, 2025" tabindex="-1">19</span><span class="flatpickr-day" aria-label="January 20, 2025" tabindex="-1">20</span><span class="flatpickr-day" aria-label="January 21, 2025" tabindex="-1">21</span><span class="flatpickr-day" aria-label="January 22, 2025" tabindex="-1">22</span><span class="flatpickr-day" aria-label="January 23, 2025" tabindex="-1">23</span><span class="flatpickr-day" aria-label="January 24, 2025" tabindex="-1">24</span><span class="flatpickr-day" aria-label="January 25, 2025" tabindex="-1">25</span><span class="flatpickr-day" aria-label="January 26, 2025" tabindex="-1">26</span><span class="flatpickr-day" aria-label="January 27, 2025" tabindex="-1">27</span><span class="flatpickr-day" aria-label="January 28, 2025" tabindex="-1">28</span><span class="flatpickr-day" aria-label="January 29, 2025" tabindex="-1">29</span><span class="flatpickr-day" aria-label="January 30, 2025" tabindex="-1">30</span><span class="flatpickr-day" aria-label="January 31, 2025" tabindex="-1">31</span><span class="flatpickr-day nextMonthDay" aria-label="February 1, 2025" tabindex="-1">1</span><span class="flatpickr-day nextMonthDay" aria-label="February 2, 2025" tabindex="-1">2</span><span class="flatpickr-day nextMonthDay" aria-label="February 3, 2025" tabindex="-1">3</span><span class="flatpickr-day nextMonthDay" aria-label="February 4, 2025" tabindex="-1">4</span><span class="flatpickr-day nextMonthDay" aria-label="February 5, 2025" tabindex="-1">5</span><span class="flatpickr-day nextMonthDay" aria-label="February 6, 2025" tabindex="-1">6</span><span class="flatpickr-day nextMonthDay" aria-label="February 7, 2025" tabindex="-1">7</span><span class="flatpickr-day nextMonthDay" aria-label="February 8, 2025" tabindex="-1">8</span></div></div></div></div></div>
