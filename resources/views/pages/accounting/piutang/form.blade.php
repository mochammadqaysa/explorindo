...
<script>
  ...
  $(() => {
    ...
    //====================================================================================================================================
    // Step 1
    $('input[name="tipe_jurnal"]').on('change', function() {
        var selectedTipe = $(this).val();
        if (selectedTipe == "lainnya") {
          $("#keterangan-lainnya").slideDown()
          $(".tipe-lainnya").slideDown()
          $(".tipe-bahan").slideUp()
          $(".tipe-barang").slideUp()
        } else if (selectedTipe == "bahan_baku") {
          $("#keterangan-lainnya").slideUp()
          $(".tipe-lainnya").slideUp()
          $(".tipe-bahan").slideDown()
          $(".tipe-barang").slideUp()
        } else if (selectedTipe == "barang_jadi") {
          $("#keterangan-lainnya").slideUp()
          $(".tipe-lainnya").slideUp()
          $(".tipe-bahan").slideUp()
          $(".tipe-barang").slideDown()
        }
    });

    var initialTipeJurnal = $('input[name="tipe_jurnal"]:checked').val();
    if (initialTipeJurnal) {
        if (initialTipeJurnal == "lainnya") {
          $("#keterangan-lainnya").slideDown()
          $(".tipe-lainnya").slideDown()
          $(".tipe-bahan").slideUp()
          $(".tipe-barang").slideUp()
        } else if (initialTipeJurnal == "bahan_baku") {
          $("#keterangan-lainnya").slideUp()
          $(".tipe-lainnya").slideUp()
          $(".tipe-bahan").slideDown()
          $(".tipe-barang").slideUp()
        } else if (initialTipeJurnal == "barang_jadi") {
          $("#keterangan-lainnya").slideUp()
          $(".tipe-lainnya").slideUp()
          $(".tipe-bahan").slideUp()
          $(".tipe-barang").slideDown()
    ...
    $('input[name="tipe_customer"]').on('change', function() {
      ...
      if (selectedTipe == "ekspor") {
        $('#ekspor-kurs').slideDown()
        $('.lokal-nilai-ppn').slideUp()
        $('.lokal-nilai-total').slideUp()
        $('.ekspor-mata-uang').slideDown()
        $('.prepend-currency').text($('input[name="mata_uang[]"]').val())
      } else {
        $('#ekspor-kurs').slideUp()
        $('.lokal-nilai-ppn').slideDown()
        $('.lokal-nilai-total').slideDown()
        $('.ekspor-mata-uang').slideUp()
        $('.prepend-currency').text("IDR")
      }
    });

    var initialTipeCustomer = $('input[name="tipe_customer"]:checked').val();
    if (initialTipeCustomer) {
      loadCustomers(initialTipeCustomer);
      if (initialTipeCustomer == "ekspor") {
        $('#ekspor-kurs').slideDown()
        $('.lokal-nilai-ppn').slideUp()
        $('.lokal-nilai-total').slideUp()
        $('.ekspor-mata-uang').slideDown()
    ...
    function formatResultBahan(res) {
      if (!res.id) {
        return res.text;
      }
      var $container = $(
    ...
    function formatSelectionBahan(res) {
      return res.text;
    }
    ...
    let initializeSelect2 =  function() {
      ...
      $('.select2-bahan').select2({
          ...
          allowClear: true, // Allows the user to clear the selection
          templateResult: formatResultBahan,  // Custom result format
          templateSelection: formatSelectionBahan // Custom selected item format
      });
      ...
      //                   $(this).closest('.form-item').find('.form-group #stok-barang').text("Stok : "+res.data.stok+" "+res.data.satuan);
      //                   $(this).closest('.form-item').find('.form-group #stok-barang').slideDown();
      //                   $(this).closest('.form-item').find('.form-group #stok-barang').attr("data-stok",res.data.stok);
    ...
    $('#add-form').click(function () {
      ...
      switch (tipeJurnal) {
        case 'lainnya':
          htmlObject.find('.tipe-lainnya').show()
          htmlObject.find('.tipe-bahan').hide()
          htmlObject.find('.tipe-barang').hide()
          break;
        case 'bahan_baku':
          htmlObject.find('.tipe-lainnya').hide()
          htmlObject.find('.tipe-bahan').show()
          htmlObject.find('.tipe-barang').hide()
          break;
        case 'barang_jadi':
          htmlObject.find('.tipe-lainnya').hide()
          htmlObject.find('.tipe-bahan').hide()
          htmlObject.find('.tipe-barang').show()
          break;
        default:
          break;
      }
